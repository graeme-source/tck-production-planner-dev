...
router.post("/", validate(CreateSupplierBody), async (req, res) => {
  const { name, contactName, email, phone, orderingPhone, website, address, notes, orderFrequency, orderDays, leadTimeDays, cutoffTime, invoiceNotRequired } = req.body;
