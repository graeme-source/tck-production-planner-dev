...
const FIRE_RA_ACTIONS: SeedAction[] = [
  ...
  { title: "Designate fire muster point in front car park", description: "At least 10m from building; clear of bins; not blocking FRS vehicle access. Mark with a post and \"Fire Assembly Point\" sign.", category: "fire", priority: "high", dueInDays: 14, assignedToName: "Graeme Carter" },
