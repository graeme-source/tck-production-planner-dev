            ...
            return (
              <div key={item.id}>
                ...
                >
                  ...
                  <span className="text-sm tabular-nums text-indigo-600 dark:text-indigo-400 font-semibold w-8 text-right flex-shrink-0">
                    {nPacks > 0 ? nPacks : "—"}
                  </span>
                ...
                {isExpanded && (
                  <div className={cn(
                    ...
                    {/* Stats: net packs + chiller trays + wonky */}
