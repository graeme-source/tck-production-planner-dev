...
function DoughOverview({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Mac cheese items — display only (no dough required) */}
      {(() => {
        ...
        return (
          <div className="bg-card border border-yellow-200 dark:border-yellow-800 rounded-xl overflow-hidden">
            <div className="px-4 py-3 border-b border-yellow-200 dark:border-yellow-800 bg-yellow-50 dark:bg-yellow-900/20">
              <h3 className="font-semibold text-base text-yellow-700 dark:text-yellow-400">Also on today's plan — No dough required</h3>
            </div>
            <div className="divide-y divide-border/40">
              {macItems.map(it => (
