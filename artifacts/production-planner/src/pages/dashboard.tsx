...
import { ArrowRight, ChefHat, Truck, Package, RefreshCw, PackageCheck, LineChart, Thermometer, AlertTriangle, CheckCircle, X, Sparkles, Salad, ClipboardList, Layers, UtensilsCrossed, Drumstick, Waves, Flame, MoonStar } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
        ...
        <DispatchOrdersPanel className="lg:col-span-2" />
