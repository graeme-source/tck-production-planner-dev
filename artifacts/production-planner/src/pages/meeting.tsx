...
function ProductionPlanSlide({ data, slide, isPreviewing }: { data: DashboardData; slide: MeetingSlide; isPreviewing: boolean }) {
  ...
  const cols = "grid-cols-[2rem_1fr_5.5rem_8rem_5.75rem_6.5rem]";
  ...
  return (
    <div>
      ...
      {isLoading && data.todayPlan.items.length === 0 ? (
        ...
        <div className="glass-panel rounded-2xl overflow-hidden">
          {/* Header */}
          <div className={cn("grid gap-2 px-5 py-3 bg-secondary/30 text-base leading-snug font-bold text-muted-foreground items-start", cols)}>
            <span>#</span>
            <span>Recipe</span>
          ...
          {rows.map((r, i) => {
            ...
            return (
              <div key={r.recipeId}>
                ...
                <div
                  className={cn(
                    "grid gap-2 items-center px-5 py-3 border-l-4",
                    cols,
                    toneClass,
