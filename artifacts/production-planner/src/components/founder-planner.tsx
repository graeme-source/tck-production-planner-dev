/**
 * The founder's planning tools — pillars, goals, recurring rituals, the
 * day's time blocks, the weekly template, the parking lot, the North Star
 * objectives and the Apple Calendar connection.
 *
 * This WAS the whole of /founder/focus until 2026-09-18, when the page
 * became just the day's diary and the founder's to-dos. Everything here
 * still works and still holds its data — it now lives behind the
 * "Planning tools" disclosure on that page. To put it back as the page,
 * render <FounderPlanner /> directly in pages/founder-focus.tsx.
 */
import { useState, useEffect, useMemo, useRef } from "react";
import { useAuth } from "@/contexts/auth-context";
import { Link } from "wouter";
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import { FocusLink } from "@/components/founder-nav";
