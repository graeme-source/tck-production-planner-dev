...
export const ingredientsTable = pgTable("ingredients", {
  ...
  // PROCESSING time only, in minutes, after cooking and before it can go into
  // a build (pull, shred, cool, portion). The day schedule's "start cooking
  // by" lead time is estimatedCookTimeMin + this (api lib/meat-lead-time.ts).
  // Until migration 0124 (2026-09-24) this was a hand-typed cook+process
  // total; existing values were converted to their processing part.
